        ...
        <main>
            <section className={styles.Release_section}>
                ...
                {isHide && dataRelease.data ?
                    <iframe width='1920' height='864' className={styles.trailer_player} src={`${dataRelease.data[0].videos.trailers[0].url}?controls=0&autoplay=true&mute=1&loop=1&enablejsapi=1`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                :
            ...
            <div className={styles.Banner_container}>
                <SiAcademia className={styles._icon}/>
                <div className={styles._center_wrapper}>
                    <h3 className={styles._text}>Подписка на Амедиатеку <span className={styles._price}>599 ₽ в месяц</span></h3>
                    <button className={styles._btn}>Оформить</button>
                </div>
            </div>
            <div className={styles.Top_container}>
